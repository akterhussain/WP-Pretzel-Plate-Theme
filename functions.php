<?php
/**
 * Pretzel Plate functions and definitions
 *
 ...
 */
function pretzel_plate_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on Pretzel Plate, use a find and replace
		* to change 'pretzel-plate' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'pretzel-plate', get_template_directory() . '/languages' );
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'pretzel_plate_custom_background_args',
			array(
 ...
 */
function pretzel_plate_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'pretzel_plate_content_width', 640 );
}
add_action( 'after_setup_theme', 'pretzel_plate_content_width', 0 );
 ...
 */
function pretzel_plate_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'pretzel-plate' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'pretzel-plate' ),
